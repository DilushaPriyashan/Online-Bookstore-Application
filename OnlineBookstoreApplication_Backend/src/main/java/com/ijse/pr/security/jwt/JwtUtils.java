...
public class JwtUtils {
    ...
    public String generateJwtToken(Authentication authentication){
        ...
        .setExpiration(new Date((new Date()).getTime()+jwtExpirationMs))    // add realt time to 86400000 ms
    ...
    public String getUsernameFromJwtToken(String authToken){    // to get the user name from the token
